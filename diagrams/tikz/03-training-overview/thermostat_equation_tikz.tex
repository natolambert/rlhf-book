...
% UNBOUNDED ink to the dark text color via \loose{}; light builds unchanged.
...
\begin{document}
\begin{tikzpicture}[
    every node/.style={text=\loose{black}},
    annot/.style={font=\small\itshape, text=annotblue, align=center},
    arrw/.style={-{Stealth[length=5pt]}, color=\loose{arrowgray}, thick}
]
