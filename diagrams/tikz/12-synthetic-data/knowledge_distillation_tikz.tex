...
\node[font=\tiny, text=\loose{black!60}] at (5.3, 1.35) {logits};

% Student logits
\node[plain, minimum width=0.9cm] (zs) at (5.3, -0.2) {$z_S$};
\node[font=\tiny, text=\loose{black!60}] at (5.3, -0.65) {logits};
...
\node[font=\tiny, text=\loose{black!60}] at (9.5, 1.35) {soft probs};

\node[plain, minimum width=0.9cm] (ps) at (9.5, -0.2) {$p_S$};
\node[font=\tiny, text=\loose{black!60}] at (9.5, -0.65) {soft probs};
...
\node[font=\scriptsize\itshape, text=\loose{black!60}] at (7.3, 0.8) {$\tau > 1$ softens};
...
\node[font=\scriptsize\itshape, text=\loose{black}] (leg-key) at (1.2, -1.6) {Key};
...
\node[draw=\loose{black!50}, dotted, rounded corners=3pt, inner sep=6pt, fit=(leg-key)(leg-frozen)] {};

% Equation - right side, same y as key
\node[font=\small, text=\loose{black}] at (10, -1.6) {$\mathcal{L}_{KL} = \sum_i p_T^{(i)} \log \frac{p_T^{(i)}}{p_S^{(i)}}$};
