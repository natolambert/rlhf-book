...
\node[font=\tiny, text=\loose{black!60}] at (1.5, 1.9) {prompts};
...
\node[font=\tiny, text=\loose{black!60}] at (8.5, 1.9) {completions};
...
\node[font=\tiny\itshape, text=\loose{black!50}, anchor=north] at (dataset.south) [yshift=-0.05cm] {used to train smaller models};
