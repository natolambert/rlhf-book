...
% --- Dark-mode switch (web only; compile with \def\figdark{1}) ---
\providecommand{\figdark}{0}
\ifnum\figdark=1
  \definecolor{inkcolor}{HTML}{CBD5E1}
  \newcommand{\loose}[1]{inkcolor}   % loose (unbounded) ink -> dark text color
\else
  \newcommand{\loose}[1]{#1}         % light: identity, leaves figure untouched
\fi

\begin{document}

\begin{tikzpicture}[
    arr/.style={->, >=Stealth, thick, draw=\loose{black!70}},
    evilcompl/.style={
    ...
    annot/.style={font=\small, text=\loose{black!70}},
    layer/.style={
...
\begin{scope}[on background layer]
    \ifnum\figdark=0\fill[black!4, rounded corners=8pt] (0.5, -11.5) rectangle (22.0, 0.8);\fi
\end{scope}
...
\begin{scope}[on background layer]
    \ifnum\figdark=0\fill[white, rounded corners=6pt] (6.0, -20.0) rectangle (21.5, -13.0);\fi
    \draw[\loose{black!20}, rounded corners=6pt] (6.0, -20.0) rectangle (21.5, -13.0);
\end{scope}
...
\draw[decorate, decoration={brace, mirror, amplitude=5pt}, thick, \loose{black!40}]
...
\begin{scope}[on background layer]
    \ifnum\figdark=0\fill[white, rounded corners=6pt] (6.0, -25.5) rectangle (21.5, -20.0);\fi
    \draw[\loose{black!20}, rounded corners=6pt] (6.0, -25.5) rectangle (21.5, -20.0);
\end{scope}
...
\begin{scope}[on background layer]
    \ifnum\figdark=0\fill[black!4, rounded corners=8pt] (0.5, -26.0) rectangle (22.0, -12.75);\fi
\end{scope}
