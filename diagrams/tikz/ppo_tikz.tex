...
% Note: shaped reward equation (moved to not overlap)
\node[note] at (10.6, 1.5) {$\tilde{r} = r - \beta \cdot KL$};

% Legend (moved to bottom right, away from main diagram)
\node[legendbox, fill=yellow!30] at (12.8, -2.5) {Trained};
\node[legendbox, fill=blue!12, draw=blue!50] at (14.5, -2.5) {Frozen};
