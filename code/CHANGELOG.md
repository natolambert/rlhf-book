...
- 2026-05-24: [PR #TODO](https://github.com/natolambert/rlhf-book/pull/TODO) added a `distillation/` module README documenting SDPO (Self-Distillation Policy Optimization) on LiveCodeBench, and listed the new module in `code/README.md` and the root `README.md`. Reference wandb runs and training-result plots are still pending (marked TODO).
