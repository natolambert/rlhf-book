...
- **Goal definition**: The finish line is when the 100-step rolling average reward first reaches your `--speedrun-target-reward` value. Before rollout-buffer iteration 100, no goal is evaluated.
