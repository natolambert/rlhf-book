...
- **Preference Relation ($\succ$)**: A symbol indicating that one completion is preferred over another, e.g., $y_{chosen} \succ y_{rejected}$. E.g. a reward model predicts the probability of a preference relation, $P(y_c \succ y_r \mid x)$.
