...
$(BUILD)/html/$(OUTPUT_FILENAME_HTML).html:	$(HTML_DEPENDENCIES)
	...
	$(COPY_CMD) book/templates/callouts.js $(BUILD)/html/
	...
	$(COPY_CMD) book/templates/callouts.js $(BUILD)/html/c/
...
files:
	...
	cp ./book/templates/callouts.js $(BUILD)/html/ || echo "Failed to copy callouts.js to $(BUILD)/html/"
	cp ./book/templates/callouts.js $(BUILD)/html/c/ || echo "Failed to copy callouts.js to $(BUILD)/html/c/"
	mkdir -p $(BUILD)/html/rl-cheatsheet
