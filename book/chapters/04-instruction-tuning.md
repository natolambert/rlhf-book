...
- If multiple stages of training are done after instruction tuning, later stages can recover from some noise in the SFT data. It is therefore more important to optimize the overall post-training pipeline than to over-optimize each individual stage.
