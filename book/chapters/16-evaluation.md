...
For agentic evaluation, the models often need to run in sandboxes, which are clearly defined worlds with specific information and rules that make evaluations reproducible.
