...
For example, Cursor used self-distillation in the form of targeted textual feedback on RL trajectories to train its Composer 2.5 coding model [@cursor2026composer25], fine-tuned from Kimi K2.5.
