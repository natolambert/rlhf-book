...
On the premise: I'd say it's less "SFT for formatting, RL for reasoning" and more that **SFT is the foundation** (and very compute efficient these datys), then **RL is how the model learns a lot more from there** — on harder problems, and adapting to the harnesses it'll be used in at deployment.
