...
This course is designed roughly for early-stage AI PhD/MS students. A traditional coursework path to this course is:
* Basics of language modeling / NLP
* Basic ML (e.g. intro to AI course and intro to ML course)

With AI agents, all the material is very accessible. I encourage people to track down rabbit holes, skip videos, go out of order, and chase what excites them.
...
In practice, yes, but the evidence is unclear.
...
For making a general model, very, but the solutions aren't too surprising. Harder tasks get more tokens.
...
There is a big shift underway from "grunt" low-skill work to expert domains like law, finance, healthcare, and consulting, which solves many of the data-company problems.
